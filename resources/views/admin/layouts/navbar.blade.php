                    ...
                    <div class="btn-group" style="font-family:'Chakra Petch', sans-serif;">
                        <div class="user-settings no-bg">
                            <button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
                                <img src="{{ asset('img_admin/user-avatar-male-5-128.png')}}" class="admin_img2 rounded-circle avatar-img" alt="avatar"> {{ Auth::user()->name; }}
                                <span class="fa fa-sort-down white_bg"></span>
                            </button>
                            <div class="dropdown-menu admire_admin">
                                <div class="popover-header">{{ Auth::user()->role; }}</div>
                                <a class="dropdown-item" href="{{ url('admin/profile') }}"><i class="fa fa-cogs"></i>Account Settings</a>
                                <a class="dropdown-item" href="{{ url('admin/users') }}"><i class="fa fa-user"></i> User Status</a>
